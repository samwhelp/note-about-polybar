...
# * https://github.com/samwhelp/note-about-polybar/blob/gh-pages/_demo/project/polybarrc-profile/polybarrc-get/remote-install.sh
# * https://github.com/samwhelp/note-about-polybar/blob/gh-pages/_demo/project/polybarrc-profile/polybarrc-get/polybarrc-get
# * https://raw.githubusercontent.com/samwhelp/note-about-polybar/gh-pages/_demo/project/polybarrc-profile/polybarrc-get/polybarrc-get
...
## $ export DEBUG_POLYBARRC_GET_INSTALL=true
is_debug () {
	if [ "$DEBUG_POLYBARRC_GET_INSTALL" = "true" ]; then
		return 0
	fi
...
base_var_init () {
	...
	if [ "none${THE_CMD_FILE_NAME}" = 'none' ]; then
		THE_CMD_FILE_NAME="polybarrc-get-install"
	fi
	...
	## Target
	## https://github.com/samwhelp/note-about-polybar/blob/gh-pages/_demo/project/polybarrc-profile/polybarrc-get/polybarrc-get
	THE_TARGET_DOWNLOAD_URL='https://raw.githubusercontent.com/samwhelp/note-about-polybar/gh-pages/_demo/project/polybarrc-profile/polybarrc-get/polybarrc-get'


	THE_TARGET_FILE_NAME="polybarrc-get"
