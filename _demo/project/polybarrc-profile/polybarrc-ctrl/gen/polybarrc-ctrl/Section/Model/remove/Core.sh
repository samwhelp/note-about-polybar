...
################################################################################
### Head: Model mod_polybarrc_profile_remove
##

mod_polybarrc_profile_remove () {

	## $ polybarrc-ctrl remove demo
	...
	if [ ! -d "$dir_path" ]; then ## check ~/.local/share/.polybarrc-profile/demo
		util_error_echo
...
##
### Tail: Model mod_polybarrc_profile_remove
################################################################################
