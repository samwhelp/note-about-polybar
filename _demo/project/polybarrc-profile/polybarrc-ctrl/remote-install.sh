...
# * https://github.com/samwhelp/note-about-polybar/blob/gh-pages/_demo/project/polybarrc-profile/polybarrc-ctrl/remote-install.sh
# * https://github.com/samwhelp/note-about-polybar/blob/gh-pages/_demo/project/polybarrc-profile/polybarrc-ctrl/polybarrc-ctrl
# * https://raw.githubusercontent.com/samwhelp/note-about-polybar/gh-pages/_demo/project/polybarrc-profile/polybarrc-ctrl/polybarrc-ctrl
...
## $ export DEBUG_POLYBARRC_CTRL_INSTALL=true
is_debug () {
	if [ "$DEBUG_POLYBARRC_CTRL_INSTALL" = "true" ]; then
		return 0
	fi
...
base_var_init () {
	...
	if [ "none${THE_CMD_FILE_NAME}" = 'none' ]; then
		THE_CMD_FILE_NAME="polybarrc-ctrl-install"
	fi
	...
	## Target
	## https://github.com/samwhelp/note-about-polybar/blob/gh-pages/_demo/project/polybarrc-profile/polybarrc-ctrl/polybarrc-ctrl
	THE_TARGET_DOWNLOAD_URL='https://raw.githubusercontent.com/samwhelp/note-about-polybar/gh-pages/_demo/project/polybarrc-profile/polybarrc-ctrl/polybarrc-ctrl'


	THE_TARGET_FILE_NAME="polybarrc-ctrl"
